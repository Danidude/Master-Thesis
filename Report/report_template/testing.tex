...
\centering
\hspace*{-1.0in}
\includegraphics[scale=0.35]{images/Graph-using-200-rounds-200-passangerss.png}
...
\ref{table:tableSafest} and \ref{table:tableShortest} show how well the algorithms did under the different simulations. 
