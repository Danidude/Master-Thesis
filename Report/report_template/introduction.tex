...
We aim to evaluate several algorithms and determine which algorithm will provide us with the         %We aim to
...
Finally, we hypothesize that ACO will produce better results than djikstra's pathfinding algorithm                 % How to structure these points....
...
several iterations the results will be fairly realistic.                                                                                                                               %Is this a good place to mention our nodes inside nodes plan?
