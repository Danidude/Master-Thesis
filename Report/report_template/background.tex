...
Dijkstra's Algorithm is a graph search algorithm created by Edsger Dijkstra in 1959 that finds the shortest path through a graph from a source node to a goal node.
