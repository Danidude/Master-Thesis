...
% short delay before passengers starts to move

% if they have spent enough time in a node they can traverse it

% Shortest, safest, mix, priority

% Fire spreads up faster than along

% Fire affects neighbouring nodes (smoke). Fire spread speeds up over time. Reaches tresholds...
